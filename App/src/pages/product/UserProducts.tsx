    ...
    return (
        <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
                    ...
                    >
                        {products.map((product) => (
                            ...
                            >
                                ...
                                <h3 style={{ color: "#333", fontSize: "18px", margin: "10px 0" }}>{product.Name}</h3>
                                <p style={{ color: "#777", fontSize: "14px", margin: "5px 0" }}>Category: {product.Category}</p>
                                <p style={{ color: "#007bff", fontSize: "16px", fontWeight: "bold" }}>${product.Price.toFixed(2)}</p>
                                {product.Status && (
                                    <span
                                        style={{
                                            display: "inline-block",
                                            padding: "5px 10px",
                                            backgroundColor: product.Status === "Available" ? "#28a745" : "#dc3545",
                                            color: "#fff",
                                            borderRadius: "5px",
                                            fontSize: "12px",
                                            marginTop: "10px",
            ...
            {isCreateModalOpen && (
                ...
                >
                    <h2 style={{ textAlign: "center", marginBottom: "20px", color: "#333" }}>Create New Product</h2>
            ...
            {isSearchModalOpen && (
                ...
                >
                    <h2 style={{ textAlign: "center", marginBottom: "20px", color: "#333" }}>Search Products</h2>
