...
const Error = () => {
    useEffect(() => {
        function drawVisor(): void {
            ...
            if (!ctx) return; // Return early if there's no 2D context
    ...
    return (
        <>
            ...
            <div className="error">
                ...
                <div className="error__description">Some thing is wrong</div>
                <Link to="/" style={{ color: "white" }} className="error__button btn-primary">
                    Back to home
                </Link>
            </div>
            <div className="astronaut">
                ...
                <div className="astronaut__cord">
                    <canvas id="cord" height="400px" width="500px"></canvas>
                </div>
